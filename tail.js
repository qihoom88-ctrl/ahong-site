/* 全站共用「頁尾動線帶」　單一真相源（40-0905-02／40-0905-03）
   ...
   長出兩塊：①接下來看這個（同主題 3 張卡）②回首頁／全部知識。合作清洗推薦另立 /qingxi.js，🚫不併進本檔
...
(function () {
  ...
  var P = {
    ...
    '/baozu/':        {t:'包租代管房東自查',     d:'交給代管前，房東自己先看這 12 條',               g:['房東','租屋','交屋']},
    '/bianmin/':      {t:'便民查詢',            d:'垃圾車、停車場，搬進去以後每天要面對的事',       g:['生活']},
    '/bianmin/shenghuo/': {t:'雙北在地生活通',   d:'垃圾清運、1999、警消、健保診所、重劃區、公車捷運，官方入口一頁點到底', g:['生活']},
    '/bikeng/':       {t:'買房避坑透視器',       d:'34 條攻略＋買房 20 問',                          g:['買房','驗屋']},
    ...
    '/heyue/':        {t:'買賣合約自查表',       d:'現況交屋不是免死金牌',                           g:['買房','合約','交屋']},
    ...
    '/shangquan/':    {t:'社區生活圈',           d:'樹林、新莊在地店家，住進去以後真的會用到的',     g:['生活']},
    '/shefu/':        {t:'六大社福津貼',         d:'現在衝去領多數會白跑',                           g:['福利']},
    '/shenshou/':     {t:'估價神獸',            d:'手機版估價，三價分開算',                         g:['估價','工具']},
    '/shuihen/':      {t:'水痕怎麼看',           d:'屋主說修好了，你怎麼確認',                       g:['驗屋','漏水']},
    ...
    '/xiushan/':      {t:'修繕報價行情',         d:'九工種數字，三站並列不取平均',                   g:['修繕','驗屋']},
